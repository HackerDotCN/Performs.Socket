...
namespace SocketServerCommonLib
{
    ...
    public class AssemblyOutDataParser
    {
        ...
        {
            m_protocolText.Add(protocolKey + ProtocolKeys.ColonSign + value.ToString());
        }
        /// <summary>
        /// 添加返回头部
        /// </summary>
        ...
        {
            m_protocolText.Add(ProtocolKeys.Code + ProtocolKeys.ColonSign + ProtocolCodes.Success.ToString());
        }
        ...
        {
            m_protocolText.Add(ProtocolKeys.Command + ProtocolKeys.ColonSign + commandKey);
        }
        ...
        /// </summary>
        /// <param name="commandKey"></param>
        public void AddDeviceCommand(string commandKey)
        {
            m_protocolText.Add(commandKey);
        }
